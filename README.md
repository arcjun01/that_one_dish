...
## Problem Statement
People often remember a dish they loved but forget the restaurant name, location, or details of the meal. Existing apps like notes, photo galleries, or social media do not organize these food memories effectively. This makes it difficult to revisit favorite dishes, recommend meals to friends, or recall personal food experiences.

## Solution
That One Dish lets users save photos of dishes along with key details such as restaurant name, location, cuisine, and personal notes. Users can log dishes from restaurants they visit or add standalone dishes for cooking inspiration. All entries are organized in a gallery view and can be shared with friends through collaborative boards or lists.
...
3. Fields: Dish name, photo, description/ingredients, optional restaurant info (name + address), personal notes
...
- **Dish:** primary object: name, photo, description, ingredients, rating, optional restaurant
...
5. The user enters the dish name, restaurant name, location, cuisine, ingredients and personal notes.
...
4. The user uploads a photo of the dish.
5. The user enters the dish name, a brief description, and key ingredients (no full recipe).
6. The user saves the entry.
7. The dish appears in the inspiration gallery.